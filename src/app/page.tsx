...
import { AppSidebar } from "@/components/sections/AppSidebar"; // adjust path
        ...
        <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <div className="flex flex-1 flex-col">
                ...
                <header className="sticky top-0 z-10 border-b border-slate-200 bg-white/70 backdrop-blur dark:border-slate-800 dark:bg-slate-900/60">
                    <div className="mx-auto flex max-w-7xl items-center justify-end px-4 py-3 md:px-6">
                        <ModeToggle />
                    </div>
                </header>
                ...
                <main className="mx-auto w-full max-w-7xl px-4 py-6 md:px-6">
                    ...
                    {page !== "dashboard" && page !== "cases" && (
                        <div className="rounded-2xl border bg-white p-6 text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
